...
### 1. 登录到 GitHub 之后，点击 [Girls-Coding-Day-Jekyll-blog-3](https://github.com/CodingGirlsClub/Girls-Coding-Day-Jekyll-blog-3) 进入仓库, 点击右上角的 `Use this template` 按钮。  
